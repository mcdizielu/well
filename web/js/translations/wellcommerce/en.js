(function (Translator) {
    // en
    Translator.add("file_selector.photo", "Photo", "wellcommerce", "en");
    Translator.add("file_selector.main", "Main", "wellcommerce", "en");
    Translator.add("file_selector.cancel", "Cancel selection", "wellcommerce", "en");
    Translator.add("file_selector.select_from_library", "Select from library", "wellcommerce", "en");
    Translator.add("file_selector.add_from_disk", "Add from disk", "wellcommerce", "en");
    Translator.add("file_selector.expand", "Expand", "wellcommerce", "en");
    Translator.add("file_selector.collapse", "Collapse", "wellcommerce", "en");
    Translator.add("file_selector.filename", "Filename", "wellcommerce", "en");
    Translator.add("file_selector.extension", "Extension", "wellcommerce", "en");
    Translator.add("file_selector.preview", "Preview", "wellcommerce", "en");
    Translator.add("product_variants_editor.label.set_for_this_product", "Attributes group for this product", "wellcommerce", "en");
    Translator.add("product_variants_editor.label.set_for_this_product_suffix", "suggested groups are highlighted", "wellcommerce", "en");
    Translator.add("product_variants_editor.label.id", "ID", "wellcommerce", "en");
    Translator.add("product_variants_editor.label.stock", "Stock", "wellcommerce", "en");
    Translator.add("product_variants_editor.label.modifier_type", "Modifier type", "wellcommerce", "en");
    Translator.add("product_variants_editor.label.modifier", "Modifier value", "wellcommerce", "en");
    Translator.add("product_variants_editor.label.price", "Price", "wellcommerce", "en");
    Translator.add("product_variants_editor.label.available_attributes", "Attributes available in this group:", "wellcommerce", "en");
    Translator.add("product_variants_editor.label.choose_attribute", "(choose an attribute)", "wellcommerce", "en");
    Translator.add("product_variants_editor.button.add_attribute", "Add new attribute", "wellcommerce", "en");
    Translator.add("product_variants_editor.button.save_attribute", "Save attribute", "wellcommerce", "en");
    Translator.add("product_variants_editor.button.add_value", "Add new value", "wellcommerce", "en");
    Translator.add("product_variants_editor.button.save_value", "Save value", "wellcommerce", "en");
    Translator.add("product_variants_editor.button.add_variant", "Add new variant", "wellcommerce", "en");
    Translator.add("product_variants_editor.button.save_variant", "Save changes", "wellcommerce", "en");
    Translator.add("product_variants_editor.button.auto_generate", "Auto-generate variants", "wellcommerce", "en");
    Translator.add("product_variants_editor.variant_editor.base_net_price", "Net price", "wellcommerce", "en");
    Translator.add("product_variants_editor.variant_editor.base_gross_price", "Gross price", "wellcommerce", "en");
    Translator.add("product_variants_editor.variant_editor.modifier_type", "Modifier type", "wellcommerce", "en");
    Translator.add("product_variants_editor.variant_editor.modifier_value", "Modifier value", "wellcommerce", "en");
    Translator.add("product_variants_editor.variant_editor.net_price", "Variant net price", "wellcommerce", "en");
    Translator.add("product_variants_editor.variant_editor.gross_price", "Variant gross price", "wellcommerce", "en");
    Translator.add("product_variants_editor.variant_editor.stock", "Stock", "wellcommerce", "en");
    Translator.add("product_variants_editor.variant_editor.symbol", "SKU", "wellcommerce", "en");
    Translator.add("product_variants_editor.variant_editor.status", "Status", "wellcommerce", "en");
    Translator.add("product_variants_editor.variant_editor.availability", "Availability", "wellcommerce", "en");
    Translator.add("product_variants_editor.variant_editor.weight", "Weight", "wellcommerce", "en");
    Translator.add("product_variants_editor.variant_editor.photos", "Choose photos", "wellcommerce", "en");
    Translator.add("product_variants_editor.variant_editor.enabled", "Enabled", "wellcommerce", "en");
    Translator.add("product_variants_editor.variant_editor.disabled", "Disabled", "wellcommerce", "en");
    ...
    Translator.add("client.benefits.headline", "If you are our registered customer", "wellcommerce", "en");
    Translator.add("client.benefits.line1", "You buy quick & easy", "wellcommerce", "en");
    Translator.add("client.benefits.line2", "You can track progress of your orders", "wellcommerce", "en");
    Translator.add("client.benefits.line3", "You will receive information about promotions", "wellcommerce", "en");
    ...
    Translator.add("client.heading.terms_conditions", "Terms & conditions", "wellcommerce", "en");
    ...
    Translator.add("common.label.producer_collection", "Producer collection", "wellcommerce", "en");
    Translator.add("common.label.none", "none", "wellcommerce", "en");
    ...
    Translator.add("pagination.button.previous_page", "Previous page", "wellcommerce", "en");
    Translator.add("pagination.button.next_page", "Next page", "wellcommerce", "en");
    ...
    Translator.add("package.heading.require", "Install package", "wellcommerce", "en");
    ...
    Translator.add("package.label.output", "Console output", "wellcommerce", "en");
    Translator.add("package.fieldset.information", "Information", "wellcommerce", "en");
    Translator.add("package.fieldset.progress", "Progress", "wellcommerce", "en");
    Translator.add("package.flash.sync.success", "Package synchronization succeeded.", "wellcommerce", "en");
    Translator.add("package.flash.operation.success", "Operation successful", "wellcommerce", "en");
    ...
    Translator.add("order.heading.address", "Billing & shipping address", "wellcommerce", "en");
    ...
    Translator.add("order.heading.coupon", "Coupon", "wellcommerce", "en");
    Translator.add("order.heading.choose_shipping_method", "Choose a shipping method", "wellcommerce", "en");
    Translator.add("order.heading.choose_payment_method", "Choose a payment method", "wellcommerce", "en");
    Translator.add("order.heading.client_orders", "Client orders", "wellcommerce", "en");
    Translator.add("order.heading.invoices", "Invoices", "wellcommerce", "en");
    ...
    Translator.add("order.button.show_order", "Show order", "wellcommerce", "en");
    ...
    Translator.add("order.cart.button.place_order", "Place an order", "wellcommerce", "en");
    ...
    Translator.add("order_status.label.order_status_group", "Group", "wellcommerce", "en");
    Translator.add("order_status.label.default_comment", "Default order's comment", "wellcommerce", "en");
    Translator.add("order_status.label.colour", "Colour", "wellcommerce", "en");
    Translator.add("order_status.comment.enabled", "Status will be visible.", "wellcommerce", "en");
    ...
    Translator.add("order_status_history.email.status_changed", "Your order status has been changed", "wellcommerce", "en");
    Translator.add("order_status_history.button.change", "Save", "wellcommerce", "en");
    Translator.add("order_note.heading.add", "Add note for order", "wellcommerce", "en");
    Translator.add("order_note.heading.list", "Order notes", "wellcommerce", "en");
    Translator.add("order_note.label.content", "Content", "wellcommerce", "en");
    Translator.add("order_note.label.created_by", "Created by", "wellcommerce", "en");
    Translator.add("order_note.label.no_history", "There are no notes for this order", "wellcommerce", "en");
    Translator.add("order_note.button.save", "Add", "wellcommerce", "en");
    ...
    Translator.add("payment_method.fieldset.shipping_methods", "Allowed shipping methods", "wellcommerce", "en");
    ...
    Translator.add("invoice.heading.add", "Issue an invoice", "wellcommerce", "en");
    Translator.add("invoice.heading.edit", "Edit an invoice", "wellcommerce", "en");
    Translator.add("invoice.heading.index", "Invoices", "wellcommerce", "en");
    Translator.add("invoice.label.number", "Invoice no.", "wellcommerce", "en");
    Translator.add("invoice.label.paid", "Mark as paid", "wellcommerce", "en");
    Translator.add("invoice.label.amount_due", "Amount due", "wellcommerce", "en");
    Translator.add("invoice.label.amount_paid", "Amount paid", "wellcommerce", "en");
    Translator.add("invoice.label.date", "Date", "wellcommerce", "en");
    Translator.add("invoice.label.due_date", "Due date", "wellcommerce", "en");
    Translator.add("invoice.label.shipping_method_name", "Shipping", "wellcommerce", "en");
    Translator.add("invoice.label.payment_method_name", "Payment", "wellcommerce", "en");
    Translator.add("invoice.label.signature", "Authorized signature", "wellcommerce", "en");
    Translator.add("invoice.label.created_at", "Created at", "wellcommerce", "en");
    Translator.add("invoice.label.created_by", "Created by", "wellcommerce", "en");
    Translator.add("invoice.label.maturity", "Default maturity", "wellcommerce", "en");
    Translator.add("invoice.button.add", "Issue an invoice", "wellcommerce", "en");
    Translator.add("invoice.button.print", "Print invoice", "wellcommerce", "en");
    Translator.add("invoice.fieldset.settings", "Invoice settings", "wellcommerce", "en");
    ...
    Translator.add("attribute_value.fieldset.attributes", "Attributes", "wellcommerce", "en");
    Translator.add("attribute_value.label.attributes", "Attributes", "wellcommerce", "en");
    ...
    Translator.add("producer_collection.heading.index", "Producer collections", "wellcommerce", "en");
    Translator.add("producer_collection.heading.add", "Add a producer collection", "wellcommerce", "en");
    Translator.add("producer_collection.heading.edit", "Edit a producer collection", "wellcommerce", "en");
    ...
    Translator.add("layout_box.layered_navigation.enable_attribute_filter", "Enable attribute filter", "wellcommerce", "en");
    ...
    Translator.add("product.label.photos", "Photos", "wellcommerce", "en");
    ...
    Translator.add("product_status.flash.no_products", "There are no products matching criteria", "wellcommerce", "en");
    ...
    Translator.add("coupon.heading.code", "Code", "wellcommerce", "en");
    Translator.add("coupon.heading.discount", "Discount", "wellcommerce", "en");
    ...
    Translator.add("coupon.label.accept", "Use", "wellcommerce", "en");
    Translator.add("coupon.label.remove", "Remove", "wellcommerce", "en");
    ...
    Translator.add("review.tip.help1", "Help others decide - add rating and review", "wellcommerce", "en");
    Translator.add("review.tip.help2", "Your rating will help others decide to choose the right product", "wellcommerce", "en");
    Translator.add("layout_box.showcase.status", "Status", "wellcommerce", "en");
    Translator.add("layout_box.showcase.tip", "Choose the status of products to be displayed in the box", "wellcommerce", "en");
    ...
    Translator.add("feature.heading.index", "Features", "wellcommerce", "en");
    Translator.add("feature.heading.add", "Add feature", "wellcommerce", "en");
    Translator.add("feature.heading.edit", "Edit feature", "wellcommerce", "en");
    Translator.add("feature.label.groups", "Groups", "wellcommerce", "en");
    Translator.add("feature.label.values", "Values", "wellcommerce", "en");
    Translator.add("feature.label.field_type.choose", "Choose field type", "wellcommerce", "en");
    Translator.add("feature.label.field_type.text_field", "Text field", "wellcommerce", "en");
    Translator.add("feature.label.field_type.text_area", "Text area", "wellcommerce", "en");
    Translator.add("feature.label.field_type.checkbox", "Checkbox", "wellcommerce", "en");
    Translator.add("feature.fieldset.groups", "Groups", "wellcommerce", "en");
    Translator.add("feature.fieldset.values", "Values", "wellcommerce", "en");
    Translator.add("feature_group.heading.index", "Feature groups", "wellcommerce", "en");
    Translator.add("feature_group.heading.add", "Add a feature group", "wellcommerce", "en");
    Translator.add("feature_group.heading.edit", "Edit a feature group", "wellcommerce", "en");
    Translator.add("feature_group.fieldset.features", "Features", "wellcommerce", "en");
    Translator.add("feature_group.fieldset.sets", "Sets", "wellcommerce", "en");
    Translator.add("feature_group.label.features", "Features", "wellcommerce", "en");
    Translator.add("feature_group.label.group", "Group", "wellcommerce", "en");
    Translator.add("feature_group.label.sets", "Sets", "wellcommerce", "en");
    Translator.add("feature_set.heading.index", "Feature sets", "wellcommerce", "en");
    Translator.add("feature_set.heading.add", "Add a feature set", "wellcommerce", "en");
    Translator.add("feature_set.heading.edit", "Edit a feature set", "wellcommerce", "en");
    Translator.add("feature_set.fieldset.groups", "Groups", "wellcommerce", "en");
    Translator.add("feature_set.label.groups", "Groups", "wellcommerce", "en");
    Translator.add("product.fieldset.features", "Features", "wellcommerce", "en");
    Translator.add("feature_editor.label.choose_set", "Choose set", "wellcommerce", "en");
    Translator.add("feature_editor.label.group", "Group", "wellcommerce", "en");
    Translator.add("feature_editor.label.feature", "Feature", "wellcommerce", "en");
    Translator.add("feature_editor.label.value", "Value", "wellcommerce", "en");
})(Translator);
