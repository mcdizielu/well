(function (Translator) {
    // pl
    Translator.add("file_selector.photo", "Zdj\u0119cie", "wellcommerce", "pl");
    Translator.add("file_selector.main", "G\u0142\u00f3wne", "wellcommerce", "pl");
    Translator.add("file_selector.cancel", "Anuluj wyb\u00f3r", "wellcommerce", "pl");
    Translator.add("file_selector.select_from_library", "Wybierz z biblioteki", "wellcommerce", "pl");
    Translator.add("file_selector.add_from_disk", "Dodaj z dysku", "wellcommerce", "pl");
    Translator.add("file_selector.expand", "Rozwi\u0144", "wellcommerce", "pl");
    Translator.add("file_selector.collapse", "Zwi\u0144", "wellcommerce", "pl");
    Translator.add("file_selector.filename", "Plik", "wellcommerce", "pl");
    Translator.add("file_selector.extension", "Rozszerzenie", "wellcommerce", "pl");
    Translator.add("file_selector.preview", "Podgl\u0105d", "wellcommerce", "pl");
    Translator.add("product_variants_editor.label.set_for_this_product", "Attributes group for this product", "wellcommerce", "pl");
    Translator.add("product_variants_editor.label.set_for_this_product_suffix", "suggested groups are highlighted", "wellcommerce", "pl");
    Translator.add("product_variants_editor.label.id", "ID", "wellcommerce", "pl");
    Translator.add("product_variants_editor.label.stock", "Stock", "wellcommerce", "pl");
    Translator.add("product_variants_editor.label.modifier_type", "Modifier type", "wellcommerce", "pl");
    Translator.add("product_variants_editor.label.modifier", "Modifier value", "wellcommerce", "pl");
    Translator.add("product_variants_editor.label.price", "Price", "wellcommerce", "pl");
    Translator.add("product_variants_editor.label.available_attributes", "Attributes available in this group:", "wellcommerce", "pl");
    Translator.add("product_variants_editor.label.choose_attribute", "(choose an attribute)", "wellcommerce", "pl");
    Translator.add("product_variants_editor.button.add_attribute", "Add new attribute", "wellcommerce", "pl");
    Translator.add("product_variants_editor.button.save_attribute", "Save attribute", "wellcommerce", "pl");
    Translator.add("product_variants_editor.button.add_value", "Add new value", "wellcommerce", "pl");
    Translator.add("product_variants_editor.button.save_value", "Save value", "wellcommerce", "pl");
    Translator.add("product_variants_editor.button.add_variant", "Add new variant", "wellcommerce", "pl");
    Translator.add("product_variants_editor.button.save_variant", "Save changes", "wellcommerce", "pl");
    Translator.add("product_variants_editor.button.auto_generate", "Auto-generate variants", "wellcommerce", "pl");
    Translator.add("product_variants_editor.variant_editor.base_net_price", "Net price", "wellcommerce", "pl");
    Translator.add("product_variants_editor.variant_editor.base_gross_price", "Gross price", "wellcommerce", "pl");
    Translator.add("product_variants_editor.variant_editor.modifier_type", "Modifier type", "wellcommerce", "pl");
    Translator.add("product_variants_editor.variant_editor.modifier_value", "Modifier value", "wellcommerce", "pl");
    Translator.add("product_variants_editor.variant_editor.net_price", "Variant net price", "wellcommerce", "pl");
    Translator.add("product_variants_editor.variant_editor.gross_price", "Variant gross price", "wellcommerce", "pl");
    Translator.add("product_variants_editor.variant_editor.stock", "Stock", "wellcommerce", "pl");
    Translator.add("product_variants_editor.variant_editor.symbol", "SKU", "wellcommerce", "pl");
    Translator.add("product_variants_editor.variant_editor.status", "Status", "wellcommerce", "pl");
    Translator.add("product_variants_editor.variant_editor.availability", "Availability", "wellcommerce", "pl");
    Translator.add("product_variants_editor.variant_editor.weight", "Weight", "wellcommerce", "pl");
    Translator.add("product_variants_editor.variant_editor.photos", "Choose photos", "wellcommerce", "pl");
    Translator.add("product_variants_editor.variant_editor.enabled", "Enabled", "wellcommerce", "pl");
    Translator.add("product_variants_editor.variant_editor.disabled", "Disabled", "wellcommerce", "pl");
    ...
    Translator.add("client.benefits.headline", "Jako zarejestrowany klient", "wellcommerce", "pl");
    Translator.add("client.benefits.line1", "kupujesz szybciej", "wellcommerce", "pl");
    Translator.add("client.benefits.line2", "mo\u017cesz \u015bledzi\u0107 stan realizacji swoich zam\u00f3wie\u0144", "wellcommerce", "pl");
    Translator.add("client.benefits.line3", "otrzymujesz dodatkowe rabaty", "wellcommerce", "pl");
    ...
    Translator.add("client.heading.terms_conditions", "Regulamin i zgody marketingowe", "wellcommerce", "pl");
    ...
    Translator.add("common.fieldset.minimum_order_amount", "Minimalna kwota zam\u00f3wienia", "wellcommerce", "pl");
    ...
    Translator.add("common.label.discount_expression", "Wz\u00f3r wyliczaj\u0105cy rabat", "wellcommerce", "pl");
    ...
    Translator.add("common.label.producer_collection", "Kolekcja producenta", "wellcommerce", "pl");
    Translator.add("common.label.none", "brak", "wellcommerce", "pl");
    ...
    Translator.add("common.label.minimum_order_amount.value", "Kwota brutto", "wellcommerce", "pl");
    Translator.add("common.label.minimum_order_amount.currency", "Waluta", "wellcommerce", "pl");
    Translator.add("common.flashes.success", "Sukces!", "wellcommerce", "pl");
    Translator.add("pagination.label.results", "Wyniki", "wellcommerce", "pl");
    Translator.add("pagination.label.of", "z", "wellcommerce", "pl");
    Translator.add("pagination.button.previous_page", "Poprzednia strona", "wellcommerce", "pl");
    Translator.add("pagination.button.next_page", "Nast\u0119pna strona", "wellcommerce", "pl");
    ...
    Translator.add("company.label.addresses", "Adres", "wellcommerce", "pl");
    ...
    Translator.add("dashboard.heading.index", "Dashboard", "wellcommerce", "pl");
    Translator.add("dashboard.heading.carts", "Koszyki", "wellcommerce", "pl");
    Translator.add("dashboard.heading.last_opinions", "Ostatnie opinie", "wellcommerce", "pl");
    Translator.add("dashboard.heading.last_orders", "Ostatnie zam\u00f3wienia", "wellcommerce", "pl");
    Translator.add("dashboard.heading.new_customers", "Nowi klienci", "wellcommerce", "pl");
    Translator.add("dashboard.heading.bestsellers", "Bestsellery", "wellcommerce", "pl");
    Translator.add("dashboard.heading.customers_online", "Klienci online", "wellcommerce", "pl");
    ...
    Translator.add("package.heading.require", "Zainstaluj modu\u0142", "wellcommerce", "pl");
    ...
    Translator.add("package.button.sync", "Synchronizuj", "wellcommerce", "pl");
    ...
    Translator.add("package.label.output", "Konsola", "wellcommerce", "pl");
    Translator.add("package.fieldset.information", "Informacje", "wellcommerce", "pl");
    Translator.add("package.fieldset.progress", "Post\u0119p operacji", "wellcommerce", "pl");
    Translator.add("package.flash.sync.success", "Synchronizacja zako\u0144czona sukcesem.", "wellcommerce", "pl");
    Translator.add("package.flash.operation.sucess", "Operacja zako\u0144czona powodzeniem", "wellcommerce", "pl");
    ...
    Translator.add("order.heading.coupon", "Kupon", "wellcommerce", "pl");
    Translator.add("order.heading.choose_shipping_method", "Wybierz form\u0119 dostawy", "wellcommerce", "pl");
    Translator.add("order.heading.choose_payment_method", "Wybierz form\u0119 p\u0142atno\u015bci", "wellcommerce", "pl");
    Translator.add("order.heading.client_orders", "Zam\u00f3wienia klienta", "wellcommerce", "pl");
    ...
    Translator.add("order.button.show_order", "Zobacz zam\u00f3wienie", "wellcommerce", "pl");
    ...
    Translator.add("order.error.minimum_order_value_not_met", "Kwota minimalna dla zam\u00f3wienia nie zosta\u0142a osi\u0105gni\u0119ta", "wellcommerce", "pl");
    ...
    Translator.add("order.cart.flash.not_added", "nie zosta\u0142 dodany do koszyka z powodu zbyt niskiego stanu magazynowego", "wellcommerce", "pl");
    Translator.add("order.cart.button.add", "Dodaj do koszyka", "wellcommerce", "pl");
    Translator.add("order.cart.button.go_to_cart", "Przejd\u017a do koszyka", "wellcommerce", "pl");
    Translator.add("order.cart.button.back_to_shopping", "Wr\u00f3\u0107 do sklepu", "wellcommerce", "pl");
    Translator.add("order.cart.button.place_order", "Z\u0142\u00f3\u017c zam\u00f3wienie", "wellcommerce", "pl");
    ...
    Translator.add("address.label.line1", "Ulica", "wellcommerce", "pl");
    Translator.add("address.label.line2", "Nr. budynku, nr. lokalu", "wellcommerce", "pl");
    Translator.add("address.label.province", "Prowincja", "wellcommerce", "pl");
    Translator.add("address.label.postal_code", "Kod pocztowy", "wellcommerce", "pl");
    ...
    Translator.add("order_status_history.email.status_changed", "Status zam\u00f3wienia zosta\u0142 zmieniony", "wellcommerce", "pl");
    Translator.add("order_note.heading.add", "Dodaj notatk\u0119 do zam\u00f3wienia", "wellcommerce", "pl");
    Translator.add("order_note.heading.list", "Notatki do zam\u00f3wienia", "wellcommerce", "pl");
    Translator.add("order_note.label.content", "Tre\u015b\u0107", "wellcommerce", "pl");
    Translator.add("order_note.label.created_by", "Utworzona przez", "wellcommerce", "pl");
    Translator.add("order_note.label.no_history", "Nie ma \u017cadnych notatek do zam\u00f3wienia", "wellcommerce", "pl");
    Translator.add("order_note.button.save", "Dodaj", "wellcommerce", "pl");
    ...
    Translator.add("payment_method.fieldset.client_groups", "Grupy klient\u00f3w", "wellcommerce", "pl");
    ...
    Translator.add("payment_method.label.client_groups", "Grupy klient\u00f3w", "wellcommerce", "pl");
    Translator.add("payment_method.tip.client_groups", "Ustaw widoczno\u015b\u0107 tylko dla wybranych grup klient\u00f3w", "wellcommerce", "pl");
    ...
    Translator.add("shipping_method.label.client_groups", "Grupy klient\u00f3w", "wellcommerce", "pl");
    ...
    Translator.add("shipping_method.fieldset.client_groups", "Grupy klient\u00f3w", "wellcommerce", "pl");
    Translator.add("shipping_method.tip.client_groups", "Ustaw widoczno\u015b\u0107 tylko dla wybranych grup klient\u00f3w", "wellcommerce", "pl");
    Translator.add("invoice.heading.add", "Wystaw faktur\u0119", "wellcommerce", "pl");
    Translator.add("invoice.heading.edit", "Edytuj faktur\u0119", "wellcommerce", "pl");
    Translator.add("invoice.heading.index", "Faktury", "wellcommerce", "pl");
    Translator.add("invoice.label.number", "Numer faktury", "wellcommerce", "pl");
    Translator.add("invoice.label.paid", "Oznacz jako op\u0142acon\u0105", "wellcommerce", "pl");
    Translator.add("invoice.label.amount_due", "Kwota do zap\u0142aty", "wellcommerce", "pl");
    Translator.add("invoice.label.amount_paid", "Kwota zap\u0142acona", "wellcommerce", "pl");
    Translator.add("invoice.label.date", "Data faktury", "wellcommerce", "pl");
    Translator.add("invoice.label.due_date", "Termin p\u0142atno\u015bci", "wellcommerce", "pl");
    Translator.add("invoice.label.shipping_method_name", "Dostawa", "wellcommerce", "pl");
    Translator.add("invoice.label.payment_method_name", "P\u0142atno\u015b\u0107", "wellcommerce", "pl");
    Translator.add("invoice.label.signature", "Osoba upowa\u017cniona", "wellcommerce", "pl");
    Translator.add("invoice.label.created_at", "Data utworzenia", "wellcommerce", "pl");
    Translator.add("invoice.label.created_by", "Utworzona przez", "wellcommerce", "pl");
    Translator.add("invoice.label.maturity", "Domy\u015blny termin p\u0142atno\u015bci", "wellcommerce", "pl");
    Translator.add("invoice.button.add", "Wystaw faktur\u0119", "wellcommerce", "pl");
    Translator.add("invoice.button.print", "Drukuj faktur\u0119", "wellcommerce", "pl");
    Translator.add("invoice.fieldset.settings", "Ustawienia faktur", "wellcommerce", "pl");
    ...
    Translator.add("attribute_value.fieldset.attributes", "Atrybuty", "wellcommerce", "pl");
    Translator.add("attribute_value.label.attributes", "Atrybuty", "wellcommerce", "pl");
    ...
    Translator.add("layered_navigation.label.price", "Filtruj po cenie", "wellcommerce", "pl");
    Translator.add("layered_navigation.label.brand", "Filtruj po marce", "wellcommerce", "pl");
    Translator.add("layout_box.layered_navigation.tip", "Ustawienia wy\u015bwietlania dla boksu", "wellcommerce", "pl");
    Translator.add("layout_box.layered_navigation.enable_price_filter", "W\u0142\u0105cz filtrowanie po cenie", "wellcommerce", "pl");
    Translator.add("layout_box.layered_navigation.enable_brand_filter", "W\u0142\u0105cz filtrowanie po marce", "wellcommerce", "pl");
    Translator.add("layout_box.layered_navigation.enable_attribute_filter", "W\u0142\u0105cz filtrowanie po cechach", "wellcommerce", "pl");
    ...
    Translator.add("producer_collection.heading.index", "Kolekcje producent\u00f3w", "wellcommerce", "pl");
    Translator.add("producer_collection.heading.add", "Dodaj kolekcj\u0119 producenta", "wellcommerce", "pl");
    Translator.add("producer_collection.heading.edit", "Edytuj kolekcj\u0119 producenta", "wellcommerce", "pl");
    ...
    Translator.add("product_status.flash.no_products", "Brak produkt\u00f3w spe\u0142niaj\u0105cych kryteria", "wellcommerce", "pl");
    ...
    Translator.add("coupon.heading.code", "Kod kuponu", "wellcommerce", "pl");
    Translator.add("coupon.heading.discount", "Rabat", "wellcommerce", "pl");
    ...
    Translator.add("review.tip.help1", "Pom\u00f3\u017c innym zdecydowa\u0107", "wellcommerce", "pl");
    Translator.add("review.tip.help2", "Twoja opinia i recenzja produktu pomo\u017ce innym klientom w podj\u0119ciu decyzji", "wellcommerce", "pl");
    ...
    Translator.add("layout_box.showcase.status", "Status", "wellcommerce", "pl");
    Translator.add("layout_box.showcase.tip", "Wybierz status dla kt\u00f3rego b\u0119d\u0105 wy\u015bwietlane produkty w boksie", "wellcommerce", "pl");
    Translator.add("layout_box.showcase.limit", "Element\u00f3w w slajdzie", "wellcommerce", "pl");
    Translator.add("client.flash.empty_wishlist", "Twoja lista \u017cycze\u0144 jest pusta", "wellcommerce", "pl");
    Translator.add("wishlist.button.add", "Dodaj do schowka", "wellcommerce", "pl");
    Translator.add("feature.heading.index", "Cechy produkt\u00f3w", "wellcommerce", "pl");
    Translator.add("feature.heading.add", "Dodaj cech\u0119", "wellcommerce", "pl");
    Translator.add("feature.heading.edit", "Edycja cechy", "wellcommerce", "pl");
    Translator.add("feature.label.groups", "Grupy", "wellcommerce", "pl");
    Translator.add("feature.label.values", "Warto\u015bci", "wellcommerce", "pl");
    Translator.add("feature.label.field_type.choose", "Wybierz typ pola", "wellcommerce", "pl");
    Translator.add("feature.label.field_type.text_field", "Pole input", "wellcommerce", "pl");
    Translator.add("feature.label.field_type.text_area", "Pole textarea", "wellcommerce", "pl");
    Translator.add("feature.label.field_type.checkbox", "Checkbox", "wellcommerce", "pl");
    Translator.add("feature.fieldset.groups", "Grupy", "wellcommerce", "pl");
    Translator.add("feature.fieldset.values", "Warto\u015bci", "wellcommerce", "pl");
    Translator.add("feature_group.heading.index", "Grupy cech", "wellcommerce", "pl");
    Translator.add("feature_group.heading.add", "Dodaj grup\u0119 cech", "wellcommerce", "pl");
    Translator.add("feature_group.heading.edit", "Edycja grupy cech", "wellcommerce", "pl");
    Translator.add("feature_group.fieldset.features", "Cechy", "wellcommerce", "pl");
    Translator.add("feature_group.fieldset.sets", "Zestawy", "wellcommerce", "pl");
    Translator.add("feature_group.label.features", "Cechy", "wellcommerce", "pl");
    Translator.add("feature_group.label.group", "Grupa", "wellcommerce", "pl");
    Translator.add("feature_group.label.sets", "Zestawy", "wellcommerce", "pl");
    Translator.add("feature_set.heading.index", "Zestawy cech", "wellcommerce", "pl");
    Translator.add("feature_set.heading.add", "Dodaj zestaw cech", "wellcommerce", "pl");
    Translator.add("feature_set.heading.edit", "Eycja zestawu cech", "wellcommerce", "pl");
    Translator.add("feature_set.fieldset.groups", "Grupy", "wellcommerce", "pl");
    Translator.add("feature_set.label.groups", "Grupy", "wellcommerce", "pl");
    Translator.add("product.fieldset.features", "Cechy", "wellcommerce", "pl");
    Translator.add("feature_editor.label.choose_set", "Wybierz zestaw cech", "wellcommerce", "pl");
    Translator.add("feature_editor.label.group", "Grupa", "wellcommerce", "pl");
    Translator.add("feature_editor.label.feature", "Cecha", "wellcommerce", "pl");
    Translator.add("feature_editor.label.value", "Warto\u015b\u0107", "wellcommerce", "pl");
})(Translator);
